...
def RunFreesurfer():
    ...
    parser.add_argument('subject', metavar='SUBJECT', help='Subject name')
    parser.add_argument('nifti', metavar='NIFTI', help='NIFTI input file')
    parser.add_argument('output', metavar='OUTPUT', help='Subject dir')
    parser.add_argument(
        '--seq',
        dest='sequence',
        action="append",
    ...
    try:
        assert os.path.isfile(args.nifti), "Input NIFTI file %s not found" % args.nifti
