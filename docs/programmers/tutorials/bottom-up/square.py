...
if app.execution.state == gc3libs.Run.State.NEW:
    ...
    print("SquareApplication successfully submitted," " remote job ID is: {}".format(app.execution.lrms_jobid))
...
while app.execution.state in [gc3libs.Run.State.SUBMITTED, gc3libs.Run.State.RUNNING]:
    ...
    print("Job state is now {}").format(app.execution.state)
...
print("Done. Results are in {}".format(app.output_dir))
