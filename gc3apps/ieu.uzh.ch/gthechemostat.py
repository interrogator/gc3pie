...
class GthechemostatScript(SessionBasedScript):
    ...
    def new_tasks(self, extra):
        ...
        for (input_file, index_chunk) in _getchunk(
            self.params.csv_input_file, self.params.chunk_size, chunk_files_dir=os.path.join(self.session.path, "tmp")
        ):
            ...
            tasks.append(GthechemostatApplication(input_file, self.params.mfunct, **extra_args))
