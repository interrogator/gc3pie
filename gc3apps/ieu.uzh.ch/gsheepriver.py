#! /usr/bin/env python
#
#   gsheepriver.py -- Front-end script for running sheepriver simulation
#   written in java.
#
...
See the output of ``gsheepriver.py --help`` for program usage
instructions.
...
class GsheepriverScript(SessionBasedScript):
    ...
    The ``gsheepriver`` command keeps a record of jobs (submitted, executed
    ...
    'SUBMITTED' or 'RUNNING' state; ``gsheepriver`` will delay submission of
    ...
    def new_tasks(self, extra):
        """
        For each input folder, create an instance of GsheepriverApplication
        """
        tasks = []
