...
class ABC_uml_Workflow(SessionBasedScript):
    ...
    def __init__(self):
        SessionBasedScript.__init__(
            self, version=__version__, application=Gfit3C_ABC_uml_Application, input_filename_pattern="*.d"
        )
    ...
    def setup_options(self):
        ...
        self.add_param(
            "-g", "--g3c", action="store", dest="g3cfile", type=existing_file, default=None, help="G3C input file."
        )
    ...
    def new_tasks(self, extra):
        ...
        if self.params.dimensions and self.params.g3cfile and self.counter < 1:
            ...
            yield (
                name,
                Gfit3C_ABC_uml_Application,
                [ABC_UML_IMAGE, self.apppot_run, self.params.output, self.params.g3cfile, self.params.dimensions],
                extra_args,
            )
