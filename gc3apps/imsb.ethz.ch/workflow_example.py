...
from applicake.applications.proteomics.openbis.dropbox import Copy2Dropbox, Copy2IdentDropbox
...
from applicake.framework.runner import ApplicationRunner, CollectorRunner, IniFileRunner, WrapperRunner
from ruffus import *
