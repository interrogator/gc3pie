...
gp.plot(
    x,
    y,
    'with linesp title "sin(x)" lt 1 pt 1',
    x,
    z,
    'title "cos(x)" pt 7',
    x,
    t,
    'title "cos(x+pi/4)" pt 11',
    x,
    w,
    'title "cos(x-pi/4)" pt 9',
)
gp.script("pause 1 'press any key to continue...'")
...
lspec = ('title "sin(x)"', 'title "cos(x)" lt 6 lc rgb "#AA0066"', 'title "cos(x+pi/4)" lt 2 pt 7')
# Call plot method
gp.plot(x, Y, lspec)
gp.script("pause 1 'press any key to continue...'")
...
# line specification
lspec = ('title "ax2+bx+c" lc rgbcolor "blue"', 'title "positive root" with points lc rgbcolor "dark-red" pt 7 ps 1')
...
# 4. create data
t = gp.linspace(-pi / 2.0, pi / 2.0, 75)
