...
class GBeastDaemon(SessionBasedDaemon):
    ...
    def new_tasks(self, extra, epath=None, emask=0):
        ...
        if "BEAST2" in epath:
            ...
            gc3libs.log.warning(
                "Unable to guess which version of BEAST you" " want to run for file %s. Assuming BEAST v1" % epath
            )
        ...
        try:
            ...
            if emask == inotifyx.IN_CLOSE_WRITE:
                app = GBeastApp(beast, jarfile, epath, self.params.cores, **extra.copy())
